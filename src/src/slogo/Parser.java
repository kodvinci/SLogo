...
public class Parser {
    ...
    public List<String[]> addCommands (List<String> l, Model model) throws Exception {
        ...
        System.out.println("size of command array " + commandList.size());
        for (int i = 0; i < commandList.size(); i++) {
            System.out.println("User input: " + Arrays.toString(commandList.get(i)));
        }
        return commandList;
    }
    ...
    public ICommand buildCommand (String[] str, Model model) throws
                                                            Exception {
